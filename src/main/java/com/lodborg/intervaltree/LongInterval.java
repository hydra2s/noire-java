...
public class LongInterval extends Interval<Long> {
	 ...
	 * is assumed to be bounded by Long.MIN_VALUE, if it extends to negative
	 * infinity, and/or Long.MAX_VALUE, if it extends to positive infinity.
	 * </p>
	...
	/**
	 * Determines if the interval is empty, meaning it contains no Longs. In
	 * particular, this method will return {@code true} for the open interval
	 * (4, 5), since there is no Long within this interval, even though the
