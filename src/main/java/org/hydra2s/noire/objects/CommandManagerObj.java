...
public class CommandManagerObj extends BasicObj {
    ...
    public static class CommandWriterBase {
        ...
        public ArrayList<CommandAgentObj.CommandAgent> agents = null;
        ...
        // TODO: correct naming
        public CommandWriterBase cmdAdd(String typeName, Function<VkCommandBuffer, VkCommandBuffer> caller, CommandAgentObj.CommandAgent... nested) {
            if (nested.length <= 1) {
