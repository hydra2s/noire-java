...
public class MemoryAllocationCInfo extends BasicCInfo {
    ...
    public class BufferCInfoMemory extends MemoryAllocationCInfo {
        public long size = 0;
        public int usage = VK_BUFFER_USAGE_STORAGE_BUFFER_BIT;


        public BufferCInfoMemory() {
            this.buffer = memAllocPointer(1);
        }
    }

    public class ImageCInfoMemory extends MemoryAllocationCInfo {
